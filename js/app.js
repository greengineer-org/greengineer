var modelController = (function () {
    ...
    var Employ = function (id, imgUrl, name, empDeg, edu, des) {
        this.id = id;
        this.imgUrl = imgUrl;
        this.name = name;
        this.empDeg = empDeg;
    ...
    return {
        ...
        getServices: function () {
            var services = [
                new Service(
                    "Energy-Simulation.PNG",
                    "Building energy simulation &amp; lighting analysis for design improvement &amp; validation",
                    "Simulations of concept planning for energy and daylight provides a clear and authentic picture of building performance. Alteration of design as per the energy efficiency &amp; daylight optimization measures at the concept planning stage are most economical. At Greengineer, we help you select the most relevant, desirable and economic measures among hundreds of options which are specific to the project."
                ),
                new Service(
                    "Compliance-Modelling.jpg",
                    "Compliance modeling for ECBC, ASHRAE, LEED, IGBC, GRIHA, EC",
                    "Compliance to the various energy codes are getting mandatory in various parts of India and other part of world. All of the building rating systems also refer one of energy codes. At Greengineer, we provide the detailed compliance report for ECBC and ASHRAE using simulation tools. The report generated by our experts can be used for showing compliance for ECBC, ASHRAE, LEED, IGBC, GRIHA and Environmental Clearances."
                ),
                new Service(
                    "ASHRAE-Level-Audit.jpg",
                    "ASHRAE level 1, 2 &amp; 3 energy audits, green audits &amp; third party commissioning",
                    "Energy and green audits are the process to get your building’s health checked. This ensures the optimal use of energy, water and material while maintaining the thermal comfort. This also helps for a better operation &amp; maintenance and measurement and verification strategies to enhance the equipment’s life and operating costs. Commissioning of Electro-Mechanical equipment ensures that the difference between design &amp; actual implementation is minimized."
                ),
                new Service(
                    "Computational-Fluid-Dynamics.JPG",
                    "Computational Fluid Dynamics (CFD analysis) and Fire Dynamics Simulation (FDS)",
                    "CFD analysis is essential to get the wind flow pattern in the concept plan which will further help in positioning and orienting the different building blocks, water bodies, plantation to avail the maximum microclimate benefits. It also helps in better placement and sizing of air conditioning and ventilation systems. FDS is a tool to understand the heat and smoke transport if a fire occurs in a building to validate the evacuation plan."
                ),
                new Service(
                    "Research-And-Policy.jpg",
                    "Research &amp; policy work",
                    "Continuous research and innovation is the way of progress. Our expertise and interest for research and policy work are in the field of green buildings, sustainable urban development, thermal comfort, energy efficiency, conservation &amp; management, water conservation &amp; harvesting, ecology, socio-economy, carbon neutrality, microclimate, and climate change etc."
                ),
                new Service(
                    "Tool-Development.jpg",
                    "Tool development for different green compliances",
                    "For any calculation or analysis work, if it is repetitive in nature, even an excel based formulated tool can save two third of the time. This will help reduce the overall project execution time and cost. For very complex calculations, the numbers are even better. Development and use of tools also helps the new person execute the task with little or no training."
                ),
                new Service(
                    "Training.jpg",
                    "Training of energy simulation &amp; code compliances",
                    "Sharing the knowledge is key to progress of humans and our society. We provide trainings to the students &amp; building professionals on process of energy modeling of buildings, evaluating the best energy efficient measures and how to achieve code compliance like ECBC and ASHRAE. The different educational videos and posters are also available in our social networking pages."
                ),
                new Service(
                    "Green-Building-Certification.jpg",
                    "Green Building certification &amp; compliance for different rating systems",
                    "The green building rating systems like LEED, IGBC, GRIHA, WELL, BEE, ASSOCHAM, PEER, EDGE, SITE etc. cover some or many sustainability and wellbeing parameters for a building development. </br></br>&rarr;&ensp; Site &amp; construction compliance </br>&rarr;&ensp; Indoor air quality management </br>&rarr;&ensp; Energy management &amp; compliance </br>&rarr;&ensp; Waste management </br>&rarr;&ensp; Material selection and purchase policy </br>&rarr;&ensp; Green housekeeping </br>&rarr;&ensp; Low carbon mobility"
                ),
            ]
            return services
        },
        getEmploys: function () {
            var employs = [
                ...
                new Employ(
                    ...
                    "Abhijit-Singh.png",
                    "Abhijit Singh",
                    "Associate: Passive design and site management",
                    "B.Arch, IPS, Indore",
                ...
                new Employ(
                    ...
                    "Neha-Bisht.jpg",
                    "Neha Bisht",
                    "Associate: Green Building Design",
                ...
                new Employ(
                    ...
                    "Naveen-Sharma.jpg",
                    "Naveen Sharma",
                    "Associate: Energy Modelling &amp; HVAC",
        ...
        renderMarkup: function (id, data) {
            ...
            switch (id) {
                ...
                case "aboutSlidesIndicators": markup = '<li data-target="#about-slide-detail" data-slide-to="%slideTo%"><i class="%icon%"></i></li>';
                    ...
                    break;
                case "services": markup = '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12"><div class="service-card"><div class="front"><img class="card-img" src="/assets/images/service/%imgUrl%" alt="%title%"><div class="card-content"><h6 class="service-title">%title%</h6><div class="info-icon"><i class="fas fa-arrow-circle-right"></i></div></div></div><div class="right"><div class="card-content"><p class="service-des">%des%</p></div></div></div></div>';
                    data.forEach(function (val) {
                        newMarkup = markup.replace("%imgUrl%", val.imgUrl);
                        newMarkup = newMarkup.replaceAll("%title%", val.title);
                        newMarkup = newMarkup.replace("%des%", val.des);
                    ...
                    break;
                case "employs": markup = '<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12"><div class="emp-card" id="%id%" data-toggle="modal" data-target="#emp-detail"><div class="emp-img"><img src="/assets/images/team/%imgUrl%" alt="%name%"></div><div class="card-highlight"><h6>%name%, <span class="emp-deg">%empDeg%</span></h6><p class="edu">%edu%</p></div><p class="short-detail">%des%</p><span class="info-icon"><i class="fas fa-info"></i></span></div></div>';
                    data.forEach(function (val) {
                        newMarkup = markup.replace("%imgUrl%", val.imgUrl);
                        newMarkup = newMarkup.replaceAll("%name%", val.name);
                        newMarkup = newMarkup.replace("%empDeg%", val.empDeg);
                    ...
                    break;
                case "empDetails": markup = '<div class="emp-img"><img src="/assets/images/team/%imgUrl%" alt="%name%"></div><h5>%name%, <span class="emp-deg">%empDeg%</span></h5><h6>%edu%</h6><p>%des%</p>';
                    newMarkup = markup.replace("%imgUrl%", data.imgUrl);
                    newMarkup = newMarkup.replaceAll("%name%", data.name);
                    newMarkup = newMarkup.replace("%empDeg%", data.empDeg);
